...
length(unique(M$Former.Church))
Churches <- M$Former.Church
...
Churches[which(WhichDenoms == " Baptist")]
...
library(geojson)
citation("ggmap")
register_google(key="AIzaSyBOo8H3KKbL2-EXiGlb5jfeBbzaFN7Jfy0", write=TRUE)

# Iterate through hometowns and get their latitude and longitude
# This takes a while and requires a key, try to only run it once
