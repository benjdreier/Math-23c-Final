...
#2- Yes, our dataset has over 3000 individuals, a very large dataset.
...
#10- See auxillary python file and the whichcontain function, defined in Section 3, or the maps analysis in Section 6, for professional-looking software engineering, and notice how we used APIs to gather data -- that's professional!
...
#BONUS POINT 10: notice that by defining and using the whichContain function, this qualifies as professional looking software engineering
...
#BONUS POINT 10: we used APIs, therefore satisfying professional looking software engineering
